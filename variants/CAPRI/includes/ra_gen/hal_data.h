...
extern const timer_instance_t g_PWM;

/** Access the GPT instance using these structures when calling API functions directly (::p_api is not used). */
extern gpt_instance_ctrl_t g_PWM_ctrl;
extern const timer_cfg_t g_PWM_cfg;
...
#else
#define g_spi1_P_TRANSFER_TX (&g_transfer4)
#endif
#if (RA_NOT_DEFINED == g_transfer5)
    #define g_spi1_P_TRANSFER_RX (NULL)
#else
#define g_spi1_P_TRANSFER_RX (&g_transfer5)
#endif
